				...
				array (
					...
					'elements' => array (
						...
						array (
							...
							'type'      => 'Label',
							'readonly'  => 'yes',
							'desc2'     => __( '<code>' . untrailingslashit( WC()->api_request_url( 'WC_Gateway_Lguplus_Vbank?type=vbank_noti', pafw_check_ssl() ) ) . '</code><div class="desc2">가상계좌 무통장입금 내역 통보에 사용되는 URL 주소입니다.<br>가상계좌 무통장입금 매뉴얼을 참고하여 LG유플러스 가맹점 관리자 페이지에 접속하여 주소를 입력하여 주시기 바랍니다.</div>', 'pgall-for-woocommerce' ),
						),
						array (
						...
						array (
							'id'        => 'lguplus_vbank_debug_ip',
							'title'     => __( '입금통보 URL 테스트IP', 'pgall-for-woocommerce' ),
							'className' => '',
							'type'      => 'Text',
							'default'   => $_SERVER['REMOTE_ADDR'],
							'tooltip'   => array (
								'title' => array (
									'content' => '입금통보 URL 테스트시 사용할 IP 주소를 기입해주세요. 워드프레스 wp-config.php 파일의 디버그 모드(WP_DEBUG 옵션이 true인 경우)를 사용하는 경우에만 적용됩니다.'
								)
							)
						),
						array (
