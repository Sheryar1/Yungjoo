...
<div class="pafw_button_wrapper">
	<input type="button" class="button pafw_action_button tips" id="pafw-refund-request" name="refund-request" data-tip="<?php _e( '전체취소', 'pgall-for-woocommerce' ); ?>" value="<?php _e( '전체취소', 'pgall-for-woocommerce' ); ?>" <?php echo $is_refundable && $is_fullly_refundable ? '' : 'disabled'; ?>>
	<?php if ( ! empty( $tid ) ) : ?>
