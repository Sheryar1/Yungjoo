		...
		<div id="et-secondary-menu">
			<?php
				if (is_user_logged_in()) : ?>
					...
					<a class="text-cap" href="/my-account/booking-details/">Bookings</a>/
					<a class="text-cap" href="<?php echo wp_logout_url(get_permalink()); ?>">Logout</a>					 
				<?php else : ?>
					<a class="text-cap" href="/wp-admin">Login</a> /
					<a class="text-cap" href="/wp-login.php?action=register">Register</a>
			<?php endif;?>
		</div>
	</div>
</div>
